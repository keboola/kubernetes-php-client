...
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicyList as ValidatingAdmissionPolicyList;
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicy as TheValidatingAdmissionPolicy;
...
class ValidatingAdmissionPolicy extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheValidatingAdmissionPolicy|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheValidatingAdmissionPolicy|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{$name}/status",
