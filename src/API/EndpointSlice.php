...
class EndpointSlice extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Discovery\V1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheEndpointSlice|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Discovery\V1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
