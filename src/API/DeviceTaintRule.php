...
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha3\DeviceTaintRuleList as DeviceTaintRuleList;
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha3\DeviceTaintRule as TheDeviceTaintRule;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;

class DeviceTaintRule extends AbstractAPI
{
    /**
     * list or watch objects of kind DeviceTaintRule
     *
     * @return DeviceTaintRuleList|mixed
     */
     ...
     *
     * @param TheDeviceTaintRule $Model
     ...
     * encountered.
     *
     * @return TheDeviceTaintRule|mixed
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Resource\V1alpha3\DeviceTaintRule $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     *
     * @param string $name name of the DeviceTaintRule
     * @return TheDeviceTaintRule|mixed
     */
     ...
     * @return TheDeviceTaintRule|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha3\DeviceTaintRule $Model, array $queries = [])
    {
        return $this->parseResponse(
    ...
    /**
     * watch individual changes to a list of DeviceTaintRule. deprecated: use the
    ...
    /**
     * watch changes to an object of kind DeviceTaintRule. deprecated: use the 'watch'
