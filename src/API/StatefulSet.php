...
class StatefulSet extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{namespace}/statefulsets/{$name}/status",
