...
class DaemonSet extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Apps\V1\DaemonSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheDaemonSet|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\DaemonSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheDaemonSet|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\DaemonSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{namespace}/daemonsets/{$name}/status",
