...
use \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\ClusterTrustBundleList as ClusterTrustBundleListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\ClusterTrustBundle as TheClusterTrustBundleV1beta1;
...
class ClusterTrustBundle extends AbstractAPI
{
     ...
     * list or watch objects of kind ClusterTrustBundle
     *
     * @return ClusterTrustBundleListV1beta1|mixed
     */
    public function listCertificatesV1beta1()
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * create a ClusterTrustBundle
     *
     * @param TheClusterTrustBundleV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * encountered.
     *
     * @return TheClusterTrustBundleV1beta1|mixed
     */
    public function createCertificatesV1beta1(\Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\ClusterTrustBundle $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/certificates.k8s.io/v1beta1/clustertrustbundles",
     ...
     * @return Status|mixed
     */
    public function deleteCollectionCertificatesV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/certificates.k8s.io/v1beta1/clustertrustbundles",
     ...
     * @return TheClusterTrustBundleV1beta1|mixed
     */
    public function readCertificatesV1beta1(string $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheClusterTrustBundleV1beta1|mixed
     */
    public function replaceCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\ClusterTrustBundle $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1beta1/clustertrustbundles/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/certificates.k8s.io/v1beta1/clustertrustbundles/{$name}",
     ...
     * @return TheClusterTrustBundleV1beta1|mixed
     */
    public function patchCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/certificates.k8s.io/v1beta1/clustertrustbundles/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchCertificatesV1beta1(string $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
