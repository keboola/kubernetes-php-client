...
class ControllerRevision extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Apps\V1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheControllerRevision|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
