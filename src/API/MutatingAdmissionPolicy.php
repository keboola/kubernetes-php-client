...
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\MutatingAdmissionPolicyList as MutatingAdmissionPolicyList;
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\MutatingAdmissionPolicy as TheMutatingAdmissionPolicy;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;

class MutatingAdmissionPolicy extends AbstractAPI
{
    /**
     * list or watch objects of kind MutatingAdmissionPolicy
     *
     * @return MutatingAdmissionPolicyList|mixed
     */
     ...
     *
     * @param TheMutatingAdmissionPolicy $Model
     ...
     * encountered.
     *
     * @return TheMutatingAdmissionPolicy|mixed
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\MutatingAdmissionPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     *
     * @param string $name name of the MutatingAdmissionPolicy
     * @return TheMutatingAdmissionPolicy|mixed
     */
     ...
     * @return TheMutatingAdmissionPolicy|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\MutatingAdmissionPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
    ...
    /**
     * watch individual changes to a list of MutatingAdmissionPolicy. deprecated: use
    ...
    /**
     * watch changes to an object of kind MutatingAdmissionPolicy. deprecated: use the
