...
class Secret extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\Secret $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheSecret|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Secret $Model, array $queries = [])
    {
        return $this->parseResponse(
