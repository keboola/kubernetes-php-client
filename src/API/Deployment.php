...
class Deployment extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Apps\V1\Deployment $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\Deployment $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\Deployment $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{namespace}/deployments/{$name}/status",
