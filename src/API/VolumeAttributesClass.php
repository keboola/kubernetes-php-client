...
use \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\VolumeAttributesClassList as VolumeAttributesClassListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\VolumeAttributesClass as TheVolumeAttributesClassV1beta1;
...
class VolumeAttributesClass extends AbstractAPI
{
     ...
     * list or watch objects of kind VolumeAttributesClass
     *
     * @return VolumeAttributesClassListV1beta1|mixed
     */
    public function listStorageV1beta1()
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * create a VolumeAttributesClass
     *
     * @param TheVolumeAttributesClassV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * encountered.
     *
     * @return TheVolumeAttributesClassV1beta1|mixed
     */
    public function createStorageV1beta1(\Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\VolumeAttributesClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/storage.k8s.io/v1beta1/volumeattributesclasses",
     ...
     * @return TheVolumeAttributesClassV1beta1|mixed
     */
    public function readStorageV1beta1(string $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheVolumeAttributesClassV1beta1|mixed
     */
    public function replaceStorageV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\VolumeAttributesClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{$name}",
     ...
     * @return TheVolumeAttributesClassV1beta1|mixed
     */
    public function deleteStorageV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{$name}",
     ...
     * @return TheVolumeAttributesClassV1beta1|mixed
     */
    public function patchStorageV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchStorageV1beta1(string $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
