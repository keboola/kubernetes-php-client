...
class ResourceQuota extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{namespace}/resourcequotas/{$name}/status",
