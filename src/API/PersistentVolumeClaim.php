...
class PersistentVolumeClaim extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\PersistentVolumeClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolumeClaim|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PersistentVolumeClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolumeClaim|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PersistentVolumeClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{namespace}/persistentvolumeclaims/{$name}/status",
