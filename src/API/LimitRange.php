...
class LimitRange extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\LimitRange $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheLimitRange|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\LimitRange $Model, array $queries = [])
    {
        return $this->parseResponse(
