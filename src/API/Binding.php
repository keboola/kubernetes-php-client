...
class Binding extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\Binding $Model, array $queries = [])
    {
     ...
     * @return TheBinding|mixed
     */
    public function createPod(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Binding $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
