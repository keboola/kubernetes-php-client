...
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBindingList as ValidatingAdmissionPolicyBindingList;
use \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBinding as TheValidatingAdmissionPolicyBinding;
...
class ValidatingAdmissionPolicyBinding extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheValidatingAdmissionPolicyBinding|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
