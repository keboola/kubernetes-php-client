...
class PersistentVolumeClaimSpec extends AbstractModel
{
     ...
     *
     * @var VolumeResourceRequirements
     */
     ...
     * default VolumeAttributesClass will be set by the persistentvolume controller if
     * it exists. If the resource referred to by volumeAttributesClass does not exist,
     * this PersistentVolumeClaim will be set to a Pending state, as reflected by the
