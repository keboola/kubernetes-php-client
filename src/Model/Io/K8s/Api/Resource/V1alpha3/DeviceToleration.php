...
/**
 * The ResourceClaim this DeviceToleration is attached to tolerates any taint that
 * matches the triple <key,value,effect> using the matching operator <operator>.
 */
class DeviceToleration extends AbstractModel
{
    /**
     ...
     * match all values and all keys. Must be a label name.
     *
     * @var string
     */
    public $key = null;
     ...
     * so that a ResourceClaim can tolerate all taints of a particular category.
     *
     * @var string
     */
     ...
     * <time when taint was adedd> + <toleration seconds>.
     *
     * @var integer
     */
     ...
     * the value must be empty, otherwise just a regular string. Must be a label value.
     *
     * @var string
     */
    public $value = null;
