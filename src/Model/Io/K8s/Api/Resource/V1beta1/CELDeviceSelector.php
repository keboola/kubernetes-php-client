 ...
 */
class CELDeviceSelector extends AbstractModel
{
    /**
     * Expression is a CEL expression which evaluates a single device. It must evaluate
     * to true when the device under consideration satisfies the desired criteria, and
     * false when it does not. Any other result is an error and causes allocation of
     * devices to abort.
     *
     ...
     * capacity named "modules". This input to this expression would have the following
     * fields:
     *
     *     device.driver
     ...
     * high-level precondition (i.e. you only want to consider devices from this
     * driver) or as part of a multi-clause expression that is meant to consider
     * devices from different drivers.
     *
     * The value type of each attribute is defined by the device definition, and users
     * who write these expressions must consult the documentation for their specific
     * drivers. The value type of each capacity is Quantity.
     *
