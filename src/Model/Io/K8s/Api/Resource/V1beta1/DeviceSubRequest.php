 ...
 * claim.spec.devices.requests[].firstAvailable array. Each is typically a request
 * for a single resource like a device, but can also ask for several identical
 * devices.
 *
 ...
 * AdminAccess is not supported for requests with a prioritized list, and recursive
 * FirstAvailable fields are not supported.
 */
class DeviceSubRequest extends AbstractModel
{
    /**
     ...
     * subrequests must specify this field.
     *
     ...
     * list of configurations for the claim. References must use the format <main
     * request>/<subrequest>.
     *
     * Must be a DNS label.
     *
     ...
     * for that device to be considered for this subrequest. All selectors must be
