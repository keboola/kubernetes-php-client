 ...
 */
class LabelSelectorAttributes extends AbstractModel
{
    /**
     ...
     * @var string
     */
    public $rawSelector = null;

    /**
     * requirements is the parsed interpretation of a label selector. All requirements
     ...
     *
     * @var
     * \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\LabelSelectorRequirement[]
     */
